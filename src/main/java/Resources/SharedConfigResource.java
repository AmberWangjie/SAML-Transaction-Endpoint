...
@Getter
@Setter
public abstract class SharedConfigResource {
    @JsonIgnore
    protected static final org.slf4j.Logger LOG = LoggerFactory.getLogger(SharedConfigResource.class);
    @JsonIgnore
    ...
    public SharedConfigResource(JKSKeyManager keyManager) {
        this.keyManager = keyManager;
    }

    public void setEntityId(String newEntityId, boolean addTokenToStore) throws UnrecoverableEntryException, NoSuchAlgorithmException, KeyStoreException {
        if (addTokenToStore) {
            try {
