...
public class SharedController {
    ...
    protected SharedConfigResource configuration;

    public SharedController(SharedConfigResource configuration) {
    ...
    public void setSigningCredential(@RequestBody Credentials credential) {
